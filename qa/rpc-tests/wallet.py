...
#   c) node1 mines 32 blocks, so now node 0 has 60001wire, node 1 has 4250wire, node2 has none.
#   d) node0 sends 601 wire to node2, in two transactions (301 wire, then 300 wire).
