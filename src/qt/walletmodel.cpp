...
static void NotifyzWIREReset(WalletModel* walletmodel)
{
    qDebug() << "NotifyzWIREReset";
...
void WalletModel::subscribeToCoreSignals()
{
    ...
    wallet->NotifyzWIREReset.connect(boost::bind(NotifyzWIREReset, this));
}
...
void WalletModel::unsubscribeFromCoreSignals()
{
    ...
    wallet->NotifyzWIREReset.disconnect(boost::bind(NotifyzWIREReset, this));
}
